...
export default function Index({ reviews = [] }) {
    ...
    const handleSendReply = () => {
        ...
        router.put(route('admin.reviews.reply', selectedReview.id), {
    ...
    const renderStars = (rating) => {
        return (
            <div className="flex gap-0.5 items-center">
                ...
                <span className="font-bold text-[#1E1E1E] ml-1">{rating}</span>
            </div>
        );
    };
                            ...
                            {reviews.length > 0 ? reviews.map((review) => (
                                <tr key={review.id} className="hover:bg-gray-50/50">
                                    ...
                                    <td className="p-5">
                                        ...
                                        {/* Tampilan jika admin sudah membalas */}
                                        {review.admin_reply && (
                    ...
                    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-[#1E1E1E]/40 backdrop-blur-sm">
                        ...
                        >
                            ...
                            <textarea
                                ...
                                placeholder="Ketik balasan untuk pelanggan ini (Misal: Terima kasih sudah order kak!)..."
                                value={replyText}
